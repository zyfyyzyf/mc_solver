...
from src.analysis_process import analysis_2, analysis_3_1, analysis_3_2,analysis_3_5,analysis_4, analysis_5
...
parser.add_argument("--feature_file_path",
                    help="测试集特征文件地址", type=str, default="data/test_feature.csv")                  
