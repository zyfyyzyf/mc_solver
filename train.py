...
parser.add_argument("--TrainDataset",
                    help="训练集位置", type=str, default="data/train-data-cleaned/train-data-cleaned.npz")
...
Train_solver_runtime = data['Train_label_data']
Train_feature = data['Train_feature_data']
Train_simple_feature = data['Train_simple_feature_data']
